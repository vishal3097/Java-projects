...
public class VD3 
{
static List <String> Men = Arrays.asList( new String[]{"Victor","Wyatt","Xavier","Yancey",
"Zeus" });
static List <String> Women = Arrays.asList(new String[]{ "Amy","Bertha","Clare","Diane",
"Erika" });
...
put("Yancey",Arrays.asList("Diane","Bertha","Amy","Clare","Erika"));
put("Xavier",Arrays.asList("Bertha","Erika","Clare","Diane","Amy"));
put("Wyatt",Arrays.asList("Amy","Diane","Clare","Bertha","Erika"));
...
System.out.println("\nThe matched pairs from Z to V");
Map<String, String> pairs = match(Women, WomenPreference, MenPreference); 
for(Map.Entry<String, String> pair:pairs.entrySet()){
System.out.println(pair.getKey() +" - "+ " "+ pair.getValue());
}
if(MPair(Men, Women, pairs, MenPreference, WomenPreference))
{ 
System.out.println("\n Pairs not match");
}
else
...
private static boolean MPair(List<String> Men, List<String> Women,Map <String, String> 
pairs, Map <String, List <String>> MenPreference, Map <String, 
List <String>> WomenPreference) 
{
